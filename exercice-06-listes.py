...
# réponse 6.1
my_list = [42, 3.14, "Hello", True, False, None]
...
# réponse 6.6
taille_tableau = len(my_list)
print(taille_tableau)
...
# exo 6.9
# Calculez la somme des nombres de la liste et affichez le résultat
my_list1 = [2.71, 42, 123, 2, 3.14, 1.61]
...
my_list2 = [2.71, 42, 123, 2, 3.14, 1.61]

# réponse 6.10

for i in my_list2:
    moyenne = sum(my_list2)/len(my_list2)
print(moyenne)
...
my_list3 = [2.71, 42, 123, 2, 3.14, 1.61]

# réponse 6.12
print("exo 6.12")

newList = [ i for i in my_list3 if i <= 10]
print(newList)
...
my_list4 = [2.71, 42, 123, 2, 3.14, 1.61]

list100 = [ i*100 for i in my_list4]
print(list100)
...
my_list6 = [2.71, 42, 123, 2, 3.14, 1.61]
